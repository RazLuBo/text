...
namespace QuanLySoTietKiem.DAO
{
    public class SoTietKiemDAO
    {
        ...
        {
            return ExecuteQuery.ExecuteNoneQuery("insertSoTietKiem @maSo , @maNV , @maKH , @maLS , @loaiSo , @ngayMoSo , @ngayHetHan , @tienGoi ", new object[] { id, idNV, idKH, idLS, loaiSo, ngayMo, ngayHetHan, tienGoi }) == 2;
        }
